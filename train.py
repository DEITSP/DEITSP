...
def arg_parser():
  ...
  parser.add_argument('--training_split', type=str, default='datasets/tsp/tsp50_train_concorde.txt')
  parser.add_argument('--validation_split', type=str, default='datasets/tsp/tsp50_test_concorde.txt')
  parser.add_argument('--test_split', type=str, default='datasets/tsp/tsp50_test_concorde.txt')
  parser.add_argument('--validation_examples', type=int, default=0)
  ...
  parser.add_argument('--inference_schedule', type=str, default='pow')
  ...
  parser.add_argument('--project_name', type=str, default='deitsp')
  ...
  parser.add_argument('--val_step', type=float, default=200)
...
def main(args):
  ...
  rank_zero_info('Parameters: %d' % sum([p.numel() for p in model.parameters()]))
